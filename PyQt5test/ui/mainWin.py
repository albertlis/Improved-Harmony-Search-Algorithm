...
class Ui_MainWin(object):
    def setupUi(self, MainWin):
        ...
        self.iterationsBox.setProperty("value", 100)
        ...
        self.hmsBox.setProperty("value", 50)
        ...
        self.hcmrBox.setProperty("value", 0.5)
        ...
        self.parMinBox.setProperty("value", 0.3)
        ...
        self.bandwidthMinBox = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.bandwidthMinBox.setMaximumSize(QtCore.QSize(112, 16777215))
        self.bandwidthMinBox.setMaximum(99999999999.0)
        self.bandwidthMinBox.setProperty("value", 5.0)
        self.bandwidthMinBox.setObjectName("bandwidthMinBox")
        self.horizontalLayout_7.addWidget(self.bandwidthMinBox)
        ...
        self.bandwidthMaxBox = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.bandwidthMaxBox.setMaximumSize(QtCore.QSize(112, 16777215))
        self.bandwidthMaxBox.setMaximum(99999999999.0)
        self.bandwidthMaxBox.setProperty("value", 50.0)
        self.bandwidthMaxBox.setObjectName("bandwidthMaxBox")
        self.horizontalLayout_9.addWidget(self.bandwidthMaxBox)
    ...
    def retranslateUi(self, MainWin):
        ...
        self.label_7.setText(_translate("MainWin", "bandwidth min"))
        self.label_9.setText(_translate("MainWin", "bandwidth max"))
